...
! function($) {
    ...
    Confirmation.prototype = $.extend({}, $.fn.tooltip.Constructor.prototype, {
        ...
        getBtnCancelClass: function() {
            var btnCancelClass, $e = this.$element,
                o = this.options
        ...
        getBtnCancelLabel: function() {
            var btnCancelLabel, $e = this.$element,
                o = this.options
